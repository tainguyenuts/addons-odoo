...
class ResPartner(models.Model):
    ...
    attitude = fields.Integer(string='Attitude (Thái độ)')
    flag_alert = fields.Integer(string='Flag Alert (Cờ báo động)')
    total_score = fields.Integer(string='Total Score (Tổng điểm)')
